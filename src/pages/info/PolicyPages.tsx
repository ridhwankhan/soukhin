  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-elevated rounded-lg shadow-sm p-8 md:p-12">
          <div className="prose prose-sm max-w-none text-ink-secondary">
            <h2 className="text-xl font-semibold text-ink mb-4">Our Commitment</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Clothing & Gift Items</h2>
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Food Items</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Non-Returnable Items</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">How to Request a Return</h2>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-elevated rounded-lg shadow-sm p-8 md:p-12">
          <div className="prose prose-sm max-w-none text-ink-secondary">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4">Information We Collect</h2>
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">How We Use Your Information</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Data Security</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Your Rights</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Contact Us</h2>
            <p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-elevated rounded-lg shadow-sm p-8 md:p-12">
          <div className="prose prose-sm max-w-none text-ink-secondary">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4">Acceptance of Terms</h2>
            <p className="mb-6">
              By accessing and using the Soukhin website, you accept and agree to comply with these Terms & Conditions.
            </p>

            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Products & Pricing</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Orders & Payment</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Delivery</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Intellectual Property</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Limitation of Liability</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-semibold text-ink mb-4 mt-8">Governing Law</h2>
            <p>
