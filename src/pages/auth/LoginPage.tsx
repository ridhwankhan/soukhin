      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          <div className="bg-elevated border border-line p-8 md:p-10">
            <div className="mb-8">
              <h1 className="font-serif text-2xl font-medium text-ink mb-1.5">Sign in</h1>
              <p className="text-sm text-ink-muted">Welcome back to Soukhin</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-ink-muted hover:text-ink-secondary transition-colors"
                  >
