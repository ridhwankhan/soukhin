...
import { categories, getFeaturedProducts, getNewArrivals } from '../../data';
import { SITE_SETTINGS } from '../../config';

const lifestyleCategories = [
  { slug: 'wearables', name: 'Wearables', nameBn: 'পোশাক', image: 'https://images.pexels.com/photos/9778148/pexels-photo-9778148.jpeg', description: 'Fashion for everyone' },
  { slug: 'home-living', name: 'Home & Living', nameBn: 'ঘর ও জীবনযাত্রা', image: 'https://images.pexels.com/photos/1648776/pexels-photo-1648776.jpeg', description: 'Premium home textiles' },
  { slug: 'food-pitha', name: 'Food & Pitha', nameBn: 'খাবার ও পিঠা', image: 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg', description: 'Traditional delicacies' },
  { slug: 'jewelry', name: 'Jewelry', nameBn: 'গয়না', image: 'https://images.pexels.com/photos/1413420/pexels-photo-1413420.jpeg', description: 'Handcrafted jewelry' },
  { slug: 'gifts', name: 'Gifts', nameBn: 'উপহার', image: 'https://images.pexels.com/photos/2641170/pexels-photo-2641170.jpeg', description: 'Curated hampers' },
  { slug: 'new-arrivals', name: 'New Arrivals', nameBn: 'নতুন সংগ্রহ', image: 'https://images.pexels.com/photos/606554/pexels-photo-606554.jpeg', description: 'Latest additions' },
];
