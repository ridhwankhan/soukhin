...
import { Facebook, Instagram, Heart, Mail, MapPin, MessageCircle } from 'lucide-react';
import { BRAND_CONFIG, CONTACT_EMAIL, DEVELOPER_EMAIL, DEVELOPER_NAME, FOOTER_LINKS, SITE_SETTINGS, WHATSAPP_URL } from '../../config';
