...
import { currentAdmin, adminUsers } from '../data';
...
export default function AdminLayout() {
  ...
  const user = currentAdmin; // In real app, get from auth context
      ...
      <div className={`transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-20'}`}>
        ...
        <header className="bg-white shadow-sm sticky top-0 z-20">
          <div className="flex items-center justify-between px-6 h-16">
            ...
            <div className="flex items-center gap-4">
              <button className="relative p-2 hover:bg-[#F5F0E8] rounded-full">
                <Bell className="w-5 h-5 text-[#666666]" />
                <span className="absolute top-1 right-1 w-2 h-2 bg-[#C2704A] rounded-full" />
              </button>
